    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PreparedStatement ps = conn.prepareStatement(query)) {
            ...
            while (rs.next()) {
                ...
                emailDetails.put("sender", StringEscapeUtils.escapeHtml4(rs.getString("sender")));
                emailDetails.put("subject", StringEscapeUtils.escapeHtml4(rs.getString("subject")));
                emailDetails.put("body", StringEscapeUtils.escapeHtml4(rs.getString("body")));
                emailDetails.put("timestamp", StringEscapeUtils.escapeHtml4(rs.getString("time")));
                ...
                emailDetails.put("isValid", isValid && isSigned);
